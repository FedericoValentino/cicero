...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/test_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef test_tb_include_vh_"
	puts $fp "`define test_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/test_tb.sv
...
remove_files -quiet -fileset sim_1 test_tb_include.vh
