...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AXI_TEST xil_defaultlib.AXI_TEST xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AXI_TEST -key {Behavioral:sim_1:Functional:AXI_TEST} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_e000.protoinst" -protoinst "protoinst_files/re2_bd.protoinst" -protoinst "protoinst_files/AXI_TEST.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AXI_TEST.wdb xsim.dir libdpi.so)
