...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_17)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../bd/AXI_TEST/ip/AXI_TEST_axi_vip_0_0_1/sim/AXI_TEST_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key AXI_TEST_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AXI_TEST_simv.daidir vcs_lib c.obj)
