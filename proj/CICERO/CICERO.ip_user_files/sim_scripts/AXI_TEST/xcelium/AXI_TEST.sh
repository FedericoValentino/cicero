...
#
# Script generated by Vivado on Thu Aug 28 10:47:24 CEST 2025
...
#
# Usage        : AXI_TEST.sh
#                AXI_TEST.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AXI_TEST.sh [-reset_run]
#                AXI_TEST.sh [-reset_log]
#                AXI_TEST.sh [-help]
#
...
#                script (type 'AXI_TEST.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_17 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_17)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AXI_TEST.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AXI_TEST.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../bd/AXI_TEST/ip/AXI_TEST_axi_vip_0_0_1/sim/AXI_TEST_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../CICERO.gen/sources_1/bd/AXI_TEST/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AXI_TEST xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AXI_TEST -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AXI_TEST_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: AXI_TEST.sh [-step]\n\
Usage: AXI_TEST.sh [-lib_map_path]\n\
Usage: AXI_TEST.sh [-reset_run]\n\
Usage: AXI_TEST.sh [-reset_log]\n\
Usage: AXI_TEST.sh [-keep_index]\n\
