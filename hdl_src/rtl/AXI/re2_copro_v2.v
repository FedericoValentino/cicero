...
`timescale 1 ns / 1 ps
	...
	) re2_copro_slave_lite_v2_S00_AXI_inst (
		//User ports
		.slv_reg0_out(slv_reg[0]),
		.slv_reg1_out(slv_reg[1]),
		.slv_reg2_out(slv_reg[2]),
		.slv_reg3_out(slv_reg[3]),
		.slv_reg4_out(slv_reg[4]),
		.slv_reg5_out(slv_reg[5]),
		.slv_reg6_out(slv_reg[6]),
		//End of user ports
